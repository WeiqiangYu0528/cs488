...
mat1 = gr.material({0.7, 1.0, 0.7}, {0.5, 0.5, 0.5}, 25, 0, 0, 0)
mat2 = gr.material({0.5, 0.5, 0.5}, {0.5, 0.5, 0.5}, 25, 1, 0, 0)
mat3 = gr.material({1.0, 0.6, 0.1}, {0.5, 0.5, 0.5}, 25, 0, 0, 0)
mat4 = gr.material({0.7, 0.6, 1.0}, {0.5, 0.5, 0.5}, 25, 0, 0, 0)
