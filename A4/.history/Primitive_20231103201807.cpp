...
bool NonhierBox::intersect(Ray& ray, IntersectionData& data) {
    ...
    // if (t_min == (m_pos.x - ray.origin.x) * invdir.x) {
    //     normal = glm::vec3(-1.0f, 0.0f, 0.0f); // Left face
    // } else if (t_min == (m_pos.x + m_size - ray.origin.x) * invdir.x) {
    //     normal = glm::vec3(1.0f, 0.0f, 0.0f); // Right face
    // } else if (t_min == (m_pos.y - ray.origin.y) * invdir.y) {
    //     normal = glm::vec3(0.0f, -1.0f, 0.0f); // Bottom face
    // } else if (t_min == (m_pos.y + m_size - ray.origin.y) * invdir.y) {
    //     normal = glm::vec3(0.0f, 1.0f, 0.0f); // Top face
    // } else if (t_min == (m_pos.z - ray.origin.z) * invdir.z) {
    //     normal = glm::vec3(0.0f, 0.0f, -1.0f); // Back face
    // } else if (t_min == (m_pos.z + m_size - ray.origin.z) * invdir.z) {
    ...
    if (intersected) {
        ...
        if (normal == glm::vec3(0.0f)) {
            std::cout << "Error: normal is 0" << std::endl;
        }
